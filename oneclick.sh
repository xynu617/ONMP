...
# @Last Modified time: 2020-02-09 22:15:35
...
项目地址：https://github.com/xynu617/ONMP
...
Install()
{
    ...
    # 获取onmp脚本
    curl -kfsSL https://raw.githubusercontent.com/xynu617/ONMP/master/onmp.sh > /opt/onmp/onmp.sh
